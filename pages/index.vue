        ...
        <div class="container">
            <div class="banner__main">
                ...
                <div class="banner__input">
                    <input type="text" placeholder="Search for a GYM or location" name="search" class="banner__input--control">
                ...
                <div class="col-lg-6 mb-3 mb-lg-0">
                    <div class="image--section__main section--one__image-one">
                        <div class="image--section__subsection">
                            ...
                            <button class="image--section__subsection--button">button</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
...
.banner {
    ...
    .banner__input button:hover .banner__input--icon {
        color: white;
    }
}
...
.section--three {
    ...
    &__image-two {
        background: url('/images/img-6.jpeg');
        background-blend-mode: darken;
        background-color: rgba(0, 0, 0, .5);
        background-size: cover;
        background-position: center center;
...
@media screen and (max-width: 600px) {
    ...
    .image--section__subsection--title {
        font-size: 40px;
    }
